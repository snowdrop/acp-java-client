...
:doctype: manpage
:revnumber: acp gen-manpage 4.7.7
:manmanual: Acp Manual
:mansource: acp gen-manpage 4.7.7
...
acp-gen-manpage - Generates man pages for all commands in the specified directory.
...
*acp gen-manpage* [*-fhVv*] [*-d*=_<outdir>_] [*-t*=_<template-dir>_] [_@<filename>_...]
