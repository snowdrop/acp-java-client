...
:doctype: manpage
:revnumber: acp-client gen-manpage 4.7.7
:manmanual: Acp-client Manual
:mansource: acp-client gen-manpage 4.7.7
:man-linkstyle: pass:[blue R < >]
= acp-client-gen-manpage(1)
...
acp-client-gen-manpage - Generates man pages for all commands in the specified directory.
...
*acp-client gen-manpage* [*-fhVv*] [*-d*=_<outdir>_] [*-t*=_<template-dir>_] [_@<filename>_...]
