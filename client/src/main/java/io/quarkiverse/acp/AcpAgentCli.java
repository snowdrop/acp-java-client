...
/**
 * CLI client for any ACP-compatible agent (OpenCode, Claude, Pi, etc.).
 *
 ...
 *
 * # Claude agent
 * java -DacpAgentBinary=claude-agent-acp AcpAgentCli
 *
 * # Pi agent
 * java -DacpAgentBinary=pi-acp AcpAgentCli
 * }</pre>
 */
public class AcpAgentCli {

    private static final Logger logger = LoggerFactory.getLogger(AcpAgentCli.class);
    ...
    /**
     * Entry point. Connects to an ACP agent, sends a prompt, and prints
